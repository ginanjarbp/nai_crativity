...
<head>
  ...
  <title>Dasboard nai crativity</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="dist/img/" alt="NAIcrativity" height="60" width="60">
  </div>
   ...
   <span class="brand-text font-weight-light">Hallo Admin</span>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
        <img src="../assets/page1/logo.png" class="img-circle elevation-5" alt="User Image" style="border-radius: 50%; width: auto; height: auto;">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">ginong</span>
